...
public class ForLoopStmt : OneBodyLoopStmt, ICloneable<ForLoopStmt>, ICanFormat {
  ...
  protected ForLoopStmt(Protector protector, ForLoopStmt original) : base(protector, original, original.LoopIndex.Name.isWildcardName() ? null : [original.LoopIndex.ToProtectClause()]) { // geniunely don't know what to do here to pass the default value besides maybe having a custom default value
